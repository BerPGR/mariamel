    ...
    <div class="w-full min-h-screen flex flex-col justify-between items-start">
        ...
        <div class="flex items-center justify-center bg-[#B3D5F4] gap-40 p-16">
            ...
            <div class="flex flex-col gap-10 p-10">
                <h1 class="text-5xl text-center">{{ $t('about') }}</h1>
                <p class="text-2xl font-medium pr-30">{{ $t('section.about1') }}</p>
                <p class="text-2xl font-medium">{{ $t('section.about2') }}</p>
                <p class="text-2xl font-medium">{{ $t('section.about3') }}</p>
            </div>
        </div>
        <div class="m-6 flex items-center gap-4">
            <p class="text-xl font-semibold">{{ $t('follow') }}</p>
            <ul>
                <li><a href="https://www.linkedin.com/in/maria-clara-de-melo-matuchewski-211027239/" target="blank">
